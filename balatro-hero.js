...
// Same default props as your React Balatro component
let spinRotation = -2.0;
let spinSpeed = 7.0;
let offset = [0.0, 0.0];
let color1 = '#0A0A0A';
let color2 = '#1E1E1E';
...
let lighting = 0.4;
let spinAmount = 0.25;
let pixelFilter = 745.0;
let spinEase = 1.0;
let isRotate = false;
let mouseInteraction = true;

function initBalatroHero() {
...
if (document.readyState === 'complete' || document.readyState === 'interactive') {
  ...
  document.addEventListener('DOMContentLoaded', initBalatroHero);
}
